...
public class CognitoLogoutHandler extends SimpleUrlLogoutSuccessHandler {
     ...
     */
    private String domain = "https://eu-central-16lkqh792r.auth.eu-central-1.amazoncognito.com";

    /**
     * An allowed callback URL.
     */
    private String logoutRedirectUrl = "http://localhost:8080"; // for CognitoLogoutHandler


    /**
     * The ID of your User Pool Client.
     */
    private String userPoolClientId = "53tm3rlhrpcleraftbp8k9is5d";
